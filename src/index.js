function getRecipe(event) {
  ...
  let prompt = `generate a simple ${cuisineChoice.value} recipe. Please make sure to include required ingredients at the beginning of the recipe. Be sure to include the recipe name first. Please do not include any special characters aside from punctuation. Add <br /> <br /> before writing the recipe.`;
  let context =
